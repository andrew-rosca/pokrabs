...
export function AppContent() {
  ...
  const globalShortcuts: ShortcutConfig[] = [
    ...
    },
    {
      ...
      ctrl: true,
      shift: true,
      handler: () => handleSaveAsClick(),
      description: 'Save view as',
      category: 'Global'
    },
    {
      key: 'Escape',
    ...
    {
      key: '?',
      handler: () => setIsCheatsheetOpen(prev => !prev),
      description: 'Toggle keyboard cheatsheet',
      category: 'Global'
    }
  ];
  ...
  return (
    <div className="app">
      ...
      <KeyboardCheatsheet isOpen={isCheatsheetOpen} onClose={() => setIsCheatsheetOpen(false)} />
    </div>
  );
}
